...
public:
	...
	static float Sin(float f)												{ return plugin::CallAndReturn<float, 0x41BCE0, float>(f); }
	static float Cos(float f)												{ return plugin::CallAndReturn<float, 0x41BCF0, float>(f); }
