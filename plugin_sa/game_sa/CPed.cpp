...
CPed::CPed(ePedType pedtype) : CPhysical(plugin::dummy), m_WeaponSlots{ plugin::dummy, plugin::dummy, plugin::dummy,
...
void CPed::SetCharCreatedBy(const uint8_t a)
{
	((void(__thiscall*)(CPed*, const uint8_t))0x5E47E0)(this, a);
}

void CPed::SetModelIndex(uint32_t index)
{
	((void(__thiscall*)(CPed*, uint32_t))0x5E4880)(this, index);
}

// Converted from thiscall void CPed::SetPedStats(ePedStats statsType) 0x5DEBC0
void CPed::SetPedStats(ePedStats nIndex)
{
	((void(__thiscall*)(CPed*, ePedStats))0x5DEBC0)(this, nIndex);
}
...
{
	return ((bool(__thiscall*)(CPed*, CEntity*, float))0x5E0730)(this, pEntity, viewAngle);
}
...
{
	return ((bool(__thiscall*)(CPed*, int, CVehicle*, bool))0x5E0820)(this, nDoor, pVehicle, bUseNodes);
}
...
bool CPed::OurPedCanSeeThisEntity(CEntity* entity, bool bForTargetingPurposes)
{
	return ((bool(__thiscall*)(CPed*, CEntity*, bool))0x5E1660)(this, entity, bForTargetingPurposes);
}

// Converted from thiscall void CPed::SortPeds(CPed** pedList,int,int) 0x5E17E0
void CPed::SortPeds(CPed** apPeds, int32_t nStartIndex, int32_t nEndIndex)
{
	((void(__thiscall*)(CPed*, CPed**, int, int))0x5E17E0)(this, apPeds, nStartIndex, nEndIndex);
}
...
void CPed::SetMoveAnimSpeed(CAnimBlendAssociation* pAnim)
{
	((void(__thiscall*)(CPed*, CAnimBlendAssociation*))0x5DEC10)(this, pAnim);
}
...
{
	((void(__thiscall*)(CPed*, float, bool, bool))0x5DEDC0)(this, fLookHeading, isPersistant, bOverride);
}
...
{
	((void(__thiscall*)(CPed*, CEntity*, bool, bool))0x5DEE40)(this, pLookEntity, bIsPersistant, bOverride);
}
...
// helper functions
//static void particleProduceFootSplash(CPed* ThePed, const CVector& Position, float Size = 0.15f, int32_t ParticleCount = 4);
//static void particleProduceFootDust(CPed* ThePed, const CVector& Position, float Size = 0.0f, int32_t ParticleCount = 4);

// 0x5E3630
//static void particleProduceFootSplash(CPed* ThePed, const CVector& Position, float Size, int32_t ParticleCount)
//{
	//
//}

// 0x5E37C0
// static void particleProduceFootDust(CPed* ThePed, const CVector& Position, float Size, int32_t ParticleCount)
//{
	//
//}

// Converted from thiscall void CPed::DoFootLanded(bool leftFoot,uchar) 0x5E5380
void CPed::DoFootLanded(bool left, bool doWobble)
{
	((void(__thiscall*)(CPed*, bool, unsigned char))0x5E5380)(this, left, doWobble);
}
...
int CPed::GetLocalDirection(CVector2D const& dir)
{
	return ((int(__thiscall*)(CPed*, CVector2D const&))0x5DEF60)(this, dir);
}
...
void CPed::AddWeaponModel(int32_t weaponId)
{
	((void(__thiscall*)(CPed*, int32_t))0x5E5ED0)(this, weaponId);
}

// Converted from thiscall void CPed::RemoveWeaponModel(int modelIndex) 0x5E3990
void CPed::RemoveWeaponModel(int32_t weaponId)
{
	((void(__thiscall*)(CPed*, int32_t))0x5E3990)(this, weaponId);
}

// Converted from thiscall void CPed::AddGogglesModel(int modelIndex,bool *pGogglesType) 0x5E3A90
void CPed::AddGogglesModel(uint32_t weaponId, bool* pbEffectFlag)
{
	((void(__thiscall*)(CPed*, uint32_t, bool*))0x5E3A90)(this, weaponId, pbEffectFlag);
}
...
void CPed::GiveDelayedWeapon(eWeaponType weaponType, uint32_t ammo)
{
	((void(__thiscall*)(CPed*, eWeaponType, uint32_t))0x5E89B0)(this, weaponType, ammo);
}

// Converted from thiscall void CPed::GiveWeapon(eWeaponType weaponType,uint ammo,bool likeUnused) 0x5E6080 ; return value is WeaponSlot
uint32_t CPed::GiveWeapon(eWeaponType weaponType, uint32_t ammoQuantity, bool GenerateOldWeaponPickup)
{
	return ((uint32_t(__thiscall*)(CPed*, eWeaponType, uint32_t, bool))0x5E6080)(this, weaponType, ammoQuantity, GenerateOldWeaponPickup);
}

// Converted from thiscall int CPed::GetWeaponSlot(eWeaponType weaponType) 0x5DF200
uint32_t CPed::GetWeaponSlot(eWeaponType weaponType)
{
	return ((uint32_t(__thiscall*)(CPed*, eWeaponType))0x5DF200)(this, weaponType);
}
...
{
	((void(__thiscall*)(CPed*, int))0x5E61F0)(this, weaponSlot);
}

// Converted from thiscall void CPed::GrantAmmo(eWeaponType weaponType,uint ammo) 0x5DF220
void CPed::GrantAmmo(eWeaponType weaponType, uint32_t ammoQuantity)
{
	((void(__thiscall*)(CPed*, eWeaponType, uint32_t))0x5DF220)(this, weaponType, ammoQuantity);
}

// Converted from thiscall void CPed::SetAmmo(eWeaponType weaponType,uint ammo) 0x5DF290
void CPed::SetAmmo(eWeaponType weaponType, uint32_t ammoQuantity)
{
	((void(__thiscall*)(CPed*, eWeaponType, uint32_t))0x5DF290)(this, weaponType, ammoQuantity);
}
...
void CPed::RemoveWeaponWhenEnteringVehicle(uint32_t nVehicleType)
{
	((void(__thiscall*)(CPed*, uint32_t))0x5E6370)(this, nVehicleType);
}
...
bool CPed::DoGunFlash(uint32_t nDuration, bool bLHand)
{
	return ((bool(__thiscall*)(CPed*, uint32_t, bool))0x5DF340)(this, nDuration, bLHand);
}

// Converted from thiscall void CPed::SetGunFlashAlpha(bool rightHand) 0x5DF400
void CPed::SetGunFlashAlpha(bool bLHand)
{
	((void(__thiscall*)(CPed*, bool))0x5DF400)(this, bLHand);
}
...
void CPed::SetWeaponSkill(eWeaponType weaponType, int8_t weaponSkill)
{
	((void(__thiscall*)(CPed*, eWeaponType, int8_t))0x5E3C10)(this, weaponType, weaponSkill);
}
...
// Virtual
//void CPed::SpecialEntityPreCollisionStuff()
//{
	//
//}

// Virtual
//void CPed::SpecialEntityCalcCollisionSteps()
//{
	//
//}
...
{
	((void(__thiscall*)(CPed*, float))0x5E79B0)(this, fLookHeading);
}

// Converted from thiscall void CPed::SetLook(CEntity *entity) 0x5E7A60
void CPed::SetLook(CEntity* pLookEntity)
{
	((void(__thiscall*)(CPed*, CEntity*))0x5E7A60)(this, pLookEntity);
}

// Converted from thiscall void CPed::SetLookTimer(uint time) 0x5DF8D0
void CPed::SetLookTimer(uint32_t nTime)
{
	((void(__thiscall*)(CPed*, uint32_t))0x5DF8D0)(this, nTime);
}
...
CEntity* CPed::AttachPedToEntity(CEntity* pEnt, CVector vecPos, uint16_t nHeading, float fHeadingLimit, eWeaponType nWeaponType)
{
	return ((CEntity * (__thiscall*)(CPed*, CEntity*, CVector, uint16_t, float, eWeaponType))0x5E7CB0)(this, pEnt, vecPos, nHeading, fHeadingLimit, nWeaponType);
}
...
CEntity* CPed::AttachPedToBike(CEntity* pEnt, CVector vecPos, uint16_t nHeading, float fHeadingLimit, float fVerticalLimit, eWeaponType nWeaponType)
{
	return ((CEntity * (__thiscall*)(CPed*, CEntity*, CVector, uint16_t, float, float, eWeaponType))0x5E7E60)(this, pEnt, vecPos, nHeading, fHeadingLimit, fVerticalLimit, nWeaponType);
}
...
void CPed::GetBonePosition(RwV3d& posn, uint32_t boneTag, bool bCalledFromCamera)
{
	((void(__thiscall*)(CPed*, RwV3d&, uint32_t, bool))0x5E4280)(this, posn, boneTag, bCalledFromCamera);
}
...
void CPed::GetTransformedBonePosition(RwV3d& posn, uint32_t boneTag, bool bCalledFromCamera)
{
	((void(__thiscall*)(CPed*, RwV3d&, uint32_t, bool))0x5E01C0)(this, posn, boneTag, bCalledFromCamera);
}
...
CTask* CPed::GetHoldingTask() // CTaskSimpleHoldEntity*
{
	return ((CTask * (__thiscall*)(CPed*))0x5E0290)(this); // CTaskSimpleHoldEntity*
}
...
void CPed::DropEntityThatThisPedIsHolding(bool deleteObj)
{
	((void(__thiscall*)(CPed*, bool))0x5E0360)(this, deleteObj);
}
...
CEntity* CPed::GiveObjectToPedToHold(int32_t modelIndex, bool dropCurrentObj)
{
	return ((CEntity* (__thiscall*)(CPed*, int32_t, bool))0x5E4390)(this, modelIndex, dropCurrentObj);
}
...
bool CPed::PedIsReadyForConversation(bool bRandomConversation)
{
	return ((bool (__thiscall *)(CPed*, bool))0x43ABA0)(this, bRandomConversation);
}
...
void CPed::DisablePedSpeech(int16_t Curtail)
{
	((void (__thiscall *)(CPed*, short))0x5EFF60)(this, Curtail);
}
...
void CPed::DisablePedSpeechForScriptSpeech(int16_t Curtail)
{
	((void (__thiscall *)(CPed*, short))0x5EFF80)(this, Curtail);
}
...
void CPed::SayScript(int ScriptID, bool OverideSilence, bool bForceAudible, bool bFrontEnd)
{
	((void (__thiscall *)(CPed*, int, unsigned char, unsigned char, unsigned char))0x5EFFB0)(this, ScriptID, OverideSilence, bForceAudible, bFrontEnd);
}

// Converted from thiscall unsigned short CPed::Say(ushort,uint,float,uchar,uchar,uchar) 0x5EFFE0
int16_t CPed::Say(uint16_t Phrase, uint32_t StartTimeDelay, float Probability, bool bOverideSilence, bool bForceAudible, bool bFrontEnd)
{
	return ((int16_t(__thiscall *)(CPed*, uint16_t, uint32_t, float, bool, bool, bool))0x5EFFE0)
		(this, Phrase, StartTimeDelay, Probability, bOverideSilence, bForceAudible, bFrontEnd);
}
...
void CPed::RemoveBodyPart(int32_t index, int8_t dirn)
{
	((void (__thiscall *)(CPed*, int32_t, int8_t))0x5F0140)(this, index, dirn);
}

// Converted from thiscall void CPed::SpawnFlyingComponent(int,char) 0x5F0190
void CPed::SpawnFlyingComponent(int32_t index, int8_t dirn)
{
	((void (__thiscall *)(CPed*, int32_t, int8_t))0x5F0190)(this, index, dirn);
}
...
void CPed::RemoveWeaponAnims(int32_t nWeaponType, float fBlendDelta)
{
	((void (__thiscall *)(CPed*, int32_t, float))0x5F0250)(this, nWeaponType, fBlendDelta);
}
