...
enum eVehicleAnimTypes
{
	ANIM_VEH_TYPE_ALIGN = 0,
	ANIM_VEH_TYPE_OPEN_OUTSIDE_FRONT,
	ANIM_VEH_TYPE_OPEN_OUTSIDE_REAR,
	ANIM_VEH_TYPE_TYPE_GETIN_FRONT,
	ANIM_VEH_TYPE_TYPE_GETIN_REAR,
	ANIM_VEH_TYPE_PULLOUT,
	ANIM_VEH_TYPE_CLOSE_INSIDE_FRONT,
	ANIM_VEH_TYPE_CLOSE_INSIDE_REAR,
	ANIM_VEH_TYPE_SHUFFLE,
	ANIM_VEH_TYPE_GETOUT_FRONT,
	ANIM_VEH_TYPE_GETOUT_REAR,
	ANIM_VEH_TYPE_JACKED,
	ANIM_VEH_TYPE_CLOSE_OUTSIDE_FRONT,
	ANIM_VEH_TYPE_CLOSE_OUTSIDE_REAR,
	ANIM_VEH_TYPE_JUMPOUT,
	ANIM_VEH_TYPE_CLOSE_DOOR_ROLLING,
	ANIM_VEH_TYPE_FALL_OUT,
	ANIM_VEH_TYPE_OPEN_OUTSIDE_LOCKED
};
